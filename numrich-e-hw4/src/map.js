...
const accessToken = "pk.eyJ1IjoiZW1uNTEwMCIsImEiOiJjbHVrNDgwamYwa3hxMmxvMjZxbGpud3M2In0._mTIJ0k1-83i0iG067VYdw";
let map;
...
const addMarker = (feature, className, clickHandler) => {
	...
	// - note that we will give the <div> the id of the "feature"
	...
	<p><span class="has-text-weight-bold">Phone: </span>${feature.properties.phone}</p>
	`;
